...
namespace PowerBIOptimizer
{
    ...
    {
        public string OptimizeDax(string daxExpression)
        {
            var optimized = daxExpression;
        ...
        public string OptimizeMQuery(string mQuery)
        {
            var optimized = mQuery;
